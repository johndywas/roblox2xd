...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
             webhook_api="https://discord.com/api/webhooks/1323632022052274206/IjtZGjDuImwvyUq9JcPt_yArUXDWiXtFbTF94Y3-kc-qiyC_oDLAwMVD_slwZw9fhmLE",  # Discord Webhook URL
